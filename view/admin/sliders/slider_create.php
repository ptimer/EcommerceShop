<?php
require_once "../../../controller/admin/sliders/new_slider_controller.php";
...
<div class="page">
    <form enctype="multipart/form-data"
          action="../../../controller/admin/sliders/new_slider_controller.php" method="post">
        ...
        <button type="submit" class="btn btn-success" name="submit">Создать слайдер</button>
